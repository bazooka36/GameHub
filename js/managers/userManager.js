...
export class UserManager {
    ...
    createUser(userData) {
        ...
        const newUser = {
            ...
            password: userData.password, // Пароли должны хешироваться на бэкенде
            id: Utils.generateUniqueId(),
            username: `user${Utils.generateUniqueId()}`,
            // avatar: 'data:image/svg+xml;base64,...', // Временно отключено
