...
export class MobileMenu {
    ...
    async showDeleteAccountModal() {
        ...
        // Use the same confirmation modal as desktop version
        ...
        if (confirmed) {
            // Trigger account deletion through user manager
            const userManager = window.gameHubApp?.getManager('user');
            if (userManager && typeof userManager.deleteAccount === 'function') {
                userManager.deleteAccount();
            } else {
                console.error('User manager not found or deleteAccount method not available');
            }
        }
    }
